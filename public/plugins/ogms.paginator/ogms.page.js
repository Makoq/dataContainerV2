...
var page = {
    ...
    "getPageListModel": function (pageCount, currentPage) {
        ...
        var appendStr = "";
        appendStr += "<li class='" + prePageClass + "' page-data='1' page-rel='firstpage'><b>首页</b></li>";
        appendStr += "<li class='" + prePageClass + "' page-data='" + prePage + "' page-rel='prepage'><b>上一页</b></li>";
        ...
        appendStr += "<li class='" + nextPageClass + "' page-data='" + nextPage + "' page-rel='nextpage'><b>下一页</b></li>";
        appendStr += "<li class='" + nextPageClass + "' page-data='" + pageCount + "' page-rel='lastpage'><b>尾页</b></li>";
        return appendStr;
